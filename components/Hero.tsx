...
const Hero: React.FC = () => (
  <section id="home" className={`flex md:flex-row flex-col ${styles.paddingY}`}>
    ...
    >
      ...
      We aim to evolve myclubai into a comprehensive AI
        marketplace, where developers can publish their products on our
        platform, ensuring that everyone has access to the best AI tools
        available. 🌟
      </p>
    </div>
